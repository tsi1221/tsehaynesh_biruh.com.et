...
const SKILL_CATEGORIES = [
  {
    ...
    skills: [
      ...
      { name: "Responsive Design and Ant Design.", level: 92 }
    ]
  },
  {
...
const Skills: React.FC = () => {
  return (
    <section id="skills" className="py-24 px-6 bg-white dark:bg-[#0a0a0a] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* Categories Grid */}
        <div className="grid lg:grid-cols-3 -mt-18 gap-8">
          {SKILL_CATEGORIES.map((cat, i) => (
            ...
            >
              {/* Icon Container - Hover Background Removed */}
